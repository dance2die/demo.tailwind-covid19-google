...
const Definition = () => {
  ...
  return (
    <section className='w-full border rounded-lg'>
      <article className='border-b bg-pink-200'>
        <h3>Coronavirus disease (COVID-19)</h3>
        <p>Also called: 2019-nCov, 2019 Novel Coronavirus</p>
        <nav>
          {/* prettier-ignore */}
          <ul>
            <li className="uppercase text-pink-900 text-sm" data-name="overview">overview</li>
            <li className="uppercase text-pink-900 text-sm" data-name="symptoms">symptoms</li>
            <li className="uppercase text-pink-900 text-sm" data-name="prevention">prevention</li>
            <li className="uppercase text-pink-900 text-sm" data-name="treatment">treatment</li>
          </ul>
        </nav>
      </article>
      <article>
