...
const DoTheFive = () => (
  <article className="border rounded-lg p-4 flex flex-col justify-center">
    ...
    <ol className="flex flex-col w-full items-start justify-start">
      <li><span className="font-semibold uppercase">Hands</span> Wash them often</li>
      <li><span className="font-semibold uppercase">Elbow</span> Cough into it</li>
      <li><span className="font-semibold uppercase">Face</span> Don't touch it</li>
      <li><span className="font-semibold uppercase">Space</span> Keep safe distance</li>
      <li><span className="font-semibold uppercase">Home</span> Stay if you can</li>
    </ol>
    </div>
  </article>
)
